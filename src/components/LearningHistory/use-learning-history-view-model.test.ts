  ...
  return {
    '2026-01-02': {
      ...
      learningTopics: [[{
        ...
        stateHistory: [
          { state: 'not-explored', timestamp: '2026-01-02T07:00:00.000Z' },
        ],
      }]],
    },
    [todayDateKey]: {
      ...
      learningTopics: [[{
        ...
        stateHistory: [
          { state: 'skipped', timestamp: '2026-01-03T09:00:00.000Z' },
        ],
      }]],
    },
  };
...
describe('LearningHistory view model', () => {
  ...
  it('should filter by date, type, status, and search query while keeping active today rows', () => {
    ...
    expect(viewModel.filteredEntries).toEqual([expect.objectContaining({
