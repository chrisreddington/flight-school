 ...
 * - `RATE_LIMIT_ISSUES_PER_MIN`, `RATE_LIMIT_ISSUES_CAP`
 */
...
export const ISSUES_GUARD = {
  rateLimit: { limit: num('RATE_LIMIT_ISSUES_PER_MIN', 20), windowMs: 60_000 },
  concurrentCap: num('RATE_LIMIT_ISSUES_CAP', 3),
} as const;
